...
//}
//
//struct MnimiWidgetEntryView : View {
...
//}
//
//struct MnimiWidget: Widget {
//    let kind: String = "MnimiWidget"
//
//    var body: some WidgetConfiguration {
//        StaticConfiguration(kind: kind, provider: Provider()) { entry in
//            if #available(iOS 17.0, *) {
//                MnimiWidgetEntryView(entry: entry)
...
struct QuickAddWidgetEntryView: View {
    ...
    var body: some View {
        ...
        .padding(10) // inner padding before the background
        ...
        .widgetURL(URL(string: "mnimi://add")) // Tap triggers app
    }
}
