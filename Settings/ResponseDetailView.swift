...
#Preview {
    ResponseDetailView(response: ResponseModel(timestamp: Date(), id: UUID(), type: "Question", desc: "The full Description here", relevantFor: "Charlie", recordingPath: URL(string:" File/file/fi")!))
}
